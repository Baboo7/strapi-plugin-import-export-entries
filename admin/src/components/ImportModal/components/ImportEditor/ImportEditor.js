...
export const ImportEditor = ({ data, dataFormat, slug, onDataChanged, onOptionsChanged }) => {
  ...
  return (
    <>
      <Accordion expanded={showOptions} onToggle={() => setShowOptions((show) => !show)} size="S" variant="secondary">
